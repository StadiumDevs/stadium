...
export const mockPrograms: ApiProgram[] = [
  ...
  },
  {
    ...
    resultsPublishedAt: "2026-06-18T12:00:00Z",
    honoraryMentions: [
      { name: "qubitrefill", videoUrl: null, githubUrl: null },
      { name: "VoiceBuy", videoUrl: null, githubUrl: null },
      { name: "LootDrop", videoUrl: null, githubUrl: null },
    ],
    galleryUrl: "https://drive.google.com/drive/folders/1FEwf_sYTRc9tRqMRuXIlqG7lviAJP5Nk?usp=drive_link",
